...
function buildHTML(v, logo) {
  ...
  return '<div style="background:#FAF0F2;padding:14px;font-family:Arial,sans-serif;width:560px">'
    ...
    + '<div style="font-size:20px">&#128722;</div></a>'
    +'<a href="https://maps.app.goo.gl/ZBwxJ18qeHzyDxBH7" style="display:flex;align-items:center;justify-content:space-between;background:#E8F0FE;border-radius:10px;padding:10px 12px;text-decoration:none;margin-top:8px">'
    +'<div><div style="font-size:13px;font-weight:700;color:#1A1A2E">Como llegar</div><div style="font-size:10px;color:#6B6B7B">Google Maps</div></div><div style="font-size:20px">&#128205;</div></a>'
    +'</div>'
    + '</div>'
}
