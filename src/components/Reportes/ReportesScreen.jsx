...
import { TrendingUp, DollarSign, ShoppingCart, Receipt, Trash2, FileDown } from 'lucide-react'
...
export default function ReportesScreen() {
  ...
  async function generarPDF() {
    ...
    const pl = period==='hoy'?'Reporte del día':period==='semana'?'Reporte semanal':'Reporte mensual'
    ...
    if (ventas.length > 0) {
      ...
      ventas.forEach(v => {
        ...
        doc.text('$'+v.tot.toFixed(2), lm+rw, y, {align:'right'}); y += 4.5
    ...
    doc.save('reporte-'+period+'-'+hoy.replace(/\//g,'-')+'.pdf')
  }
        ...
        <div className="card">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 space-y-1.5">
              ...
              <StockRow color="bg-gold"   label="Stock mínimo" n={stockData.low}/>
