...
import { TrendingUp, DollarSign, ShoppingCart, Receipt, Trash2, FileDown, ChevronLeft, ChevronRight } from 'lucide-react'
            ...
            : <div className="space-y-1">
                {[...ventas].reverse().slice(0,30).map(v => (
                  <button key={v.num} onClick={() => setDetalle(v)}
                    ...
                    <span className="font-bold text-ink">${(v.tot||0).toFixed(2)}</span>
                  </button>
                ))}
              </div>
          }
