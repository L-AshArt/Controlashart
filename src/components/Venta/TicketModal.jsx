...
export default function TicketModal({ venta, onClose }) {
  ...
  async function sharePDF() {
    ...
    try {
      // Cargar ticket.html en iframe invisible pero dentro del viewport
      ...
      // Esperar carga del iframe + scripts CDN
      ...
      // Llamar getTicketPDFBlob — genera el PDF completo con links dentro del iframe
