  ...
  return (
    <div>
      ...
      <div className="px-4 py-4 space-y-3">
        ...
        <Section id="mayo" icon={Percent} title="Precios mayoreo"
          subtitle="Configurado por producto en Catálogo" color="bg-rosa/10 text-rosa">
          <p className="text-xs text-ink-3 leading-relaxed">
            Los precios de mayoreo se configuran individualmente en cada producto desde el Catálogo (botón ✏️).
            Al agregar al carrito, el sistema usa el precio de mayoreo cuando el cliente compra en cantidad.
          </p>
          <p className="text-xs text-ink-2 font-semibold mt-1">
            Productos con mayoreo configurado: {(db.prods||[]).filter(p=>p.precioMayoreo>0).length}
          </p>
        </Section>
