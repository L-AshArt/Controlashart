...
export function CartProvider({ children }) {
  ...
  function clearCart() { setCart({}); setPriceOverrides({}); setLibres([]) }
  ...
  return (
    <CartCtx.Provider value={{ cart, setCart, cartItems, addToCart, remFromCart, clearCart, cartCount, cartTotal, priceOverrides, setOverride, clearOverrides, getPrice, libres, addLibre, remLibre }}>
      {children}
    </CartCtx.Provider>
  )
}
